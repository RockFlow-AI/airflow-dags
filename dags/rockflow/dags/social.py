...
SimpleHttpOperator(
  ...
  method='POST',
  http_conn_id='flow-social',
  endpoint='/social/inner/arena/analysis/batch?callTime=HK_START',
  response_check=lambda response: response.json()['code'] == 200,
  extra_options={"timeout": 60},
...
SimpleHttpOperator(
  ...
  method='POST',
  http_conn_id='flow-social',
  endpoint='/social/inner/arena/analysis/batch?callTime=HK_END',
  response_check=lambda response: response.json()['code'] == 200,
  extra_options={"timeout": 60},
...
SimpleHttpOperator(
  ...
  method='POST',
  http_conn_id='flow-social',
  endpoint='/social/inner/arena/analysis/batch?callTime=US_START',
  response_check=lambda response: response.json()['code'] == 200,
  extra_options={"timeout": 60},
...
SimpleHttpOperator(
  ...
  method='POST',
  http_conn_id='flow-social',
  endpoint='/social/inner/arena/analysis/batch?callTime=US_END',
  response_check=lambda response: response.json()['code'] == 200,
  extra_options={"timeout": 60},
